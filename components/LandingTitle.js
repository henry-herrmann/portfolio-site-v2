        ...
        <div className='flex h-[100vh] flex-col sm:block justify-between bg-gradient-to-tr from-gradient-1 to-gradient-2'>
            <div className='flex justify-center items-center'>
                <div className='text-center max-w-screen-md mt-36 sm:mt-64 ml:m-0 mr:m-0'>
                    ...
                    <p className='text-xl font-light fade-animation transition-opacity duration-[1200ms] delay-[500ms] opacity-0 motion-reduce:transition-none'>Java, JS and Dart Developer.</p>
                </div>
            </div>
            <div className='sm:flex sm:justify-center w-[100vw] sm:w-auto fade-animation transition-opacity duration-[1200ms] delay-[800ms] opacity-0 motion-reduce:transition-none'>
            ...
            <div className='flex flex-col sm:flex-row justify-center mt-14 sm:mt-8'>
                <div className='flex flex-col justify-center items-center mr-10 ml-10 sm:ml-0 fade-animation transition-opacity duration-[1200ms] delay-[1100ms] opacity-0 motion-reduce:transition-none'>
                ...
                <div className='flex flex-col justify-center items-center mt-6 sm:m-0 fade-animation transition-opacity duration-[1200ms] delay-[1400ms] opacity-0 motion-reduce:transition-none'>
                    <div className="rounded-lg bg-white w-20 h-20 flex justify-center items-center">
