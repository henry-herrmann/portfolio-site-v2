...
export default function LandingTitle(){
    ...
    return (
        <div className='landing-title flex h-auto flex-col sm:block bg-herrmann-gray-light'>
            <div className='flex justify-center'>
                <div className="flex justify-center items-center mt-36 sm:mt-48  mb-7 sm:mb-0">
                    <div className='text-center max-w-screen-md xl:mr-[10vw] 2xl:mr-[12vw]'>
                        ...
                        <p className='text-lg md:text-xl font-light mr-4 ml-4 fade-animation transition-opacity duration-[1200ms] delay-[200ms] opacity-0 motion-reduce:transition-none'>Computer Science Student & Software Engineer</p>
            ...
            <div id="about"  className='flex items-center justify-center p-7 sm:mt-20'></div>
        </div>
    );
}