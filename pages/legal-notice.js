    ...
    return (
        <Fragment>
            ...
            <div className='min-h-screen'>
                ...
                <BlockContent>
                  <div>
                      <strong className='font-semibold text-xl sm:text-2xl'>Entries referred to § 5 TMG</strong><br/>
                      ...
                      <p className='font-light'>
                          <strong className='font-semibold text-xl sm:text-2xl'>Represented by:</strong><br/>
                          Henry Herrmann<br/><br/>
                      </p>
                      <p className='font-light'>
                          <strong className='font-semibold text-xl sm:text-2xl'>Contact:</strong><br/>
                      ...
                      <p className='font-light'>
                          ...
                          <strong className='font-semibold text-xl sm:text-2xl'>Liability for links</strong>
                          <br/><br/>
                          ...
                          <br/><br/>
                          <strong className='font-semibold text-xl sm:text-2xl'>Copyright</strong>
                          <br/><br/>
                          ...
                          <br/><br/>
                          <strong className='font-semibold text-xl sm:text-2xl'>Data privacy</strong>
                          <br/><br/>
